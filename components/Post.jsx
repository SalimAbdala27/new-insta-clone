...
const Post = (props) => {
  ...
  const likePost = async () => { // allows only one like per user
    if (hasLiked){
  ...
  return (
    <div className="bg-white my-7 border rounded-sm">
      ...
      <form className="flex items-center p-4">
        ...
        <input type="text" value={comment} onChange={(e) => setComment(e.target.value)} className="border-none flex-1 focus:ring-0 outline-none" placeholder="Add a comment..."/>
